...
class DragonColony(object):
    ...
    def __init__(self, strategy, skynet, dragon_types, create_places, dimensions,
                 food=2):
        """Creation of a DragonColony for simulating a game.
    ...
    def simulate(self):
        """Used for Simulating an attack on the dragon colony (i.e., play the game)."""
    ...
    def deploy_dragon(self, place_name, dragon_type_name):
        """dragon is deployed only if enough food is available.
